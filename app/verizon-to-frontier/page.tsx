...
export const metadata: Metadata = {
  ...
  keywords: ["verizon frontier", "fios frontier", "frontier is verizon", "verizon fios now frontier", "did verizon sell to frontier", "frontier verizon merger", "frontier fios"],
}
