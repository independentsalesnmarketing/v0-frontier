...
export const metadata: Metadata = {
  title: "Internet Speed Guide: How Much Speed Do You Need? | Frontier Deals",
  description: "Find the right internet speed for streaming, gaming, working from home, and more. Speed recommendations from 25 Mbps to 7 Gbps with comparisons and expert tips.",
  alternates: { canonical: "/internet-speeds" },
  openGraph: {
    title: "Internet Speed Guide — How Much Do You Actually Need?",
    description: "Expert speed recommendations for every activity. Find the right Frontier Fiber plan for your household.",
    type: "website",
  },
  keywords: ["internet speed guide", "how much internet speed do I need", "internet speed for streaming", "internet speed for gaming", "mbps meaning", "download speed vs upload speed", "internet speed recommendations"],
}
