...
const speedData: Record<string, {
  ...
  "25": {
    ...
    plan: { name: "Frontier Fiber 500", price: "$34.99/mo", href: "/internet" },
    ...
    comparison: "25 Mbps is the absolute minimum for modern internet use. While it technically qualifies as broadband, most households will find it limiting. Frontier doesn't offer a 25 Mbps plan because their entry-level Fiber 500 plan at $34.99/mo delivers 20x the speed for an exceptional value.",
  },
  "50": {
    ...
    comparison: "50 Mbps is workable for small households but leaves little headroom. As more devices connect and streaming quality increases, you'll feel the squeeze. Frontier Fiber 500 at $34.99/mo gives you 10x the bandwidth for rock-solid performance.",
  },
  "100": {
    ...
    comparison: "100 Mbps is solid for everyday use but prices are often high from cable providers for this tier. Frontier doesn't offer a 100 Mbps plan — instead, they start at 500 Mbps for just $34.99/mo, giving you 5x the speed at a competitive price.",
  },
  "150": {
    ...
    comparison: "150 Mbps plans from cable providers typically cost $55-75/mo. With Frontier, you get Fiber 500 — more than 3x the speed — for just $34.99/mo. If you're paying for 150 Mbps cable, switching to Frontier saves you $25-45/mo while tripling your speed.",
  },
  "200": {
    ...
    comparison: "200 Mbps is a popular tier from cable providers, often priced $55-70/mo. With Frontier, you skip 200 Mbps entirely and jump to 500 Mbps for only $34.99/mo — more than double the speed for less money.",
  },
  "250": {
    ...
    comparison: "250 Mbps plans run $60-80/mo on cable. Frontier's Fiber 500 gives you twice the speed for only $34.99/mo — and unlike cable, you get 250 Mbps upload too, not just download.",
  },
  "300": {
    ...
    comparison: "300 Mbps plans from cable providers run $65-85/mo. Frontier Fiber 500 gives you 67% more speed at $34.99/mo. And unlike cable, Frontier's upload speed matches the download — 500 Mbps both ways.",
  },
  "400": {
    ...
    comparison: "400 Mbps cable plans cost $70-90/mo. Frontier's Fiber 500 at $34.99/mo gives you 25% more speed and 10x the upload bandwidth — cable's 400 Mbps download typically pairs with only 20-40 Mbps upload.",
  },
  "500": {
    ...
    comparison: "This is Frontier's best-value plan. At $34.99/mo with 500/500 Mbps symmetrical speeds, no data caps, and a free eero router, it beats nearly every competitor on both speed and price. Cable providers charge $70-100/mo for similar download speeds — with a fraction of the upload.",
  },
  "600": {
