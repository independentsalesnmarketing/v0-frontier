...
export const metadata: Metadata = {
  ...
  description: "Get Frontier fiber internet bundled with Netflix, YouTube TV, and more. Enjoy fast streaming with no buffering and save on your entertainment bundle.",
